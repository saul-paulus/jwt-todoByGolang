...
konversi dari data xml / json ke struct
...
// 	XMLName xml.Name `json:"Infogempa"`
...
// 		Wilayah1  string `json:"Wilayah1"`
// 		Wilayah2  string `json:"Wilayah2"`
// 		Wilayah3  string `json:"Wilayah3"`
// 		Wilayah4  string `json:"Wilayah4"`
// 		Wilayah5  string `json:"Wilayah5"`
// 		Potensi   string `json:"Potensi"`
// 	} `json:"gempa"`
// }

// // Memanggil dataBmkg
// func CreateDataBmkg(c *gin.Context) {
// 	var td *Infogempa
